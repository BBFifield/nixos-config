{
  ...
  semver = fetchFromGitHub {
    ...
    repo = "semver";
    tag = "v1.0.0-rc";
    hash = "sha256-rM4+Zt/CDCUKOCEGcbwcXQee5mhfya1JwLyNzjMtYME=";
  };
...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchFromGitHub {
      ...
      repo = "SpaghettiKart";
      rev = "e71c422afbadb49aef7fbcaae02b74eb214f72c1";
      hash = "sha256-Hk3boP/olOM9ODZwrk7xcCSLcVsx5v092EuYsBMAvFw=";
    ...
    cmakeFlags = [
      ...
      (lib.cmakeFeature "FETCHCONTENT_SOURCE_DIR_TOMLPLUSPLUS" "${tomlplusplus}")
      (lib.cmakeFeature "FETCHCONTENT_SOURCE_DIR_SEMVER" "${semver}")
    ];
