    ...
    wayland.windowManager.hyprland.settings = {
      exec-once =
        ...
        ++ (lib.optionals (config.hm.wallpaper.daemon == "hyprpaper") [
          "uwsm app -t service -u hyprpapercycle.service -- ${(import ../../utilities/wallpaper/hyprpaper/cycle.nix {inherit config pkgs;})}/bin/hyprpapercycle 300 random"
          "uwsm app -t service -u hyprpapercyclectl.service -- ${(import ../../utilities/wallpaper/hyprpaper/cycleCtl.nix {inherit pkgs;})}/bin/hyprpapercyclectl"
        ]);
    };
