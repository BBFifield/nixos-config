    ...
    wayland.windowManager.hyprland = {
      settings = {
        ...
        in [
          ...
          "workspace 8, initialClass:^(info.cemu.Cemu)$"
          "workspace 8, initialClass:^(Ryujinx)$"
          "workspace 8, initialClass:^(rpcs3)$"
          "workspace 8, initialClass:^(mupen64plus)$"
          "workspace 8, initialClass:^(retroArch)$"
